...
public class Guarana extends Plant {
   Guarana(World organism_world, Container world_organisms, Organism organisms_array[][], boolean born, int parent_pos_x, int parent_pos_y) {
        ...
        if (born == false) {
            while (true) {
                ...
                if (organisms_array[posX][posY] == null) {
                    setOrganism(0, 0, 1, "Guarana", posX, posY, organism_world);
   ...
   Guarana(World organism_world,Container world_organisms, Organism organisms_array[][]){
        boolean born = false;
        int parent_pos_x=0 , parent_pos_y=0;
        new Guarana(organism_world,world_organisms,organisms_array,born,parent_pos_x,parent_pos_y);
    }
...
@Override
    ...
    int defence(Container world_organisms, Organism organisms_array[][], int moveX, int moveY) {
        ...
        super.defence(world_organisms, organisms_array, moveX, moveY);
        return 0;
    }
}
